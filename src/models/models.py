...
class Workout(Base):
    ...
    pool_length_m: Mapped[float | None] = mapped_column(Float, nullable=True)
    pool_laps: Mapped[int | None] = mapped_column(Integer, nullable=True)
...
class Goal(Base):
    ...
    target_workouts_per_week: Mapped[int | None] = mapped_column(Integer, nullable=True)
    target_calories_per_week: Mapped[float | None] = mapped_column(Float, nullable=True)
